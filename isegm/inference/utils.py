...
from isegm.data.datasets import GrabCutDataset, BerkeleyDataset, DavisDataset, SBDEvaluationDataset, PascalVocDataset, Davis585Dataset, COCOMValDataset, CocoLvisDataset
...
def get_dataset(dataset_name, cfg):
    ...
    elif dataset_name == 'LVIS_val_PATH':
        dataset = CocoLvisDataset(cfg.LVIS_val_PATH, init_mask_mode='zero')
