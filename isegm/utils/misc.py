...
def save_checkpoint(net, checkpoints_path, epoch=None, prefix='', verbose=True, distributed=False): # ema_net
    if epoch is None:
    ...
    torch.save({'state_dict': net.state_dict(),
                # 'ema_state_dict': ema_net.state_dict() if ema_net else None,
